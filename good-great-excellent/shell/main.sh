...
cd $HOME/xiao/stage/good-great-excellent/shell
...
# run my scripts
$HOME/xiao/stage/good-great-excellent/.stack-work/install/x86_64-linux/lts-6.11/7.10.3/bin/good-great-excellent-exe
